...
function getStorage(o){
    var info=sessionStorage.getItem(o);
    var data=eval( '('+info+')' );
...
function setStorage(u,info){
    sessionStorage.setItem(u,JSON.stringify(info));
}
...
var showLoading = function () {
    var str = '<div id="lodingBox"><img src="static/image/loadingr.gif" width="90px"/></div>';
         $("body").append(str);
}
//停止动画
